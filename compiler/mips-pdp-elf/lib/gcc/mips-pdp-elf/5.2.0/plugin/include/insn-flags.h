...
static inline rtx gen_extvmisalignsi                  (rtx, rtx, rtx, rtx);
static inline rtx
gen_extvmisalignsi(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_extvmisaligndi                  (rtx, rtx, rtx, rtx);
static inline rtx
gen_extvmisaligndi(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
extern rtx        gen_extvsi                          (rtx, rtx, rtx, rtx);
extern rtx        gen_extvdi                          (rtx, rtx, rtx, rtx);
static inline rtx gen_extzvmisalignsi                 (rtx, rtx, rtx, rtx);
static inline rtx
gen_extzvmisalignsi(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_extzvmisaligndi                 (rtx, rtx, rtx, rtx);
static inline rtx
gen_extzvmisaligndi(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
extern rtx        gen_extzvsi                         (rtx, rtx, rtx, rtx);
extern rtx        gen_extzvdi                         (rtx, rtx, rtx, rtx);
static inline rtx gen_insvmisalignsi                  (rtx, rtx, rtx, rtx);
static inline rtx
gen_insvmisalignsi(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
static inline rtx gen_insvmisaligndi                  (rtx, rtx, rtx, rtx);
static inline rtx
gen_insvmisaligndi(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
