...
enum opt_code
{
  ...
  OPT_mabs_ = 1141,                          /* -mabs= */
  OPT_march_ = 1142,                         /* -march= */
  OPT_mbranch_cost_ = 1143,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1144,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1145,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1146,                /* -mcode-readable= */
  OPT_mdebug = 1147,                         /* -mdebug */
  OPT_mdebugd = 1148,                        /* -mdebugd */
  OPT_mdivide_breaks = 1149,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1150,                  /* -mdivide-traps */
  OPT_mdmx = 1151,                           /* -mdmx */
  OPT_mdouble_float = 1152,                  /* -mdouble-float */
  OPT_mdsp = 1153,                           /* -mdsp */
  OPT_mdspr2 = 1154,                         /* -mdspr2 */
  OPT_meb = 1155,                            /* -meb */
  OPT_mel = 1156,                            /* -mel */
  OPT_membedded_data = 1157,                 /* -membedded-data */
  OPT_meva = 1158,                           /* -meva */
  OPT_mexplicit_relocs = 1159,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1160,                  /* -mextern-sdata */
  OPT_mfix_24k = 1161,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1162,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1163,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1164,                     /* -mfix-r4400 */
  OPT_mfix_rm7000 = 1165,                    /* -mfix-rm7000 */
  OPT_mfix_sb1 = 1166,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1167,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1168,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1169,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1170,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1171,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1172,                 /* -mfp-exceptions */
  OPT_mfp32 = 1173,                          /* -mfp32 */
  OPT_mfp64 = 1174,                          /* -mfp64 */
  OPT_mfpxx = 1175,                          /* -mfpxx */
  OPT_mfused_madd = 1176,                    /* -mfused-madd */
  OPT_mgp32 = 1177,                          /* -mgp32 */
  OPT_mgp64 = 1178,                          /* -mgp64 */
  OPT_mgpopt = 1179,                         /* -mgpopt */
  OPT_mhard_float = 1180,                    /* -mhard-float */
  OPT_mimadd = 1181,                         /* -mimadd */
  OPT_minterlink_compressed = 1182,          /* -minterlink-compressed */
  OPT_minterlink_mips16 = 1183,              /* -minterlink-mips16 */
  OPT_mips = 1184,                           /* -mips */
  OPT_mips16 = 1185,                         /* -mips16 */
  OPT_mips3d = 1186,                         /* -mips3d */
  OPT_mllsc = 1187,                          /* -mllsc */
  OPT_mlocal_sdata = 1188,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1189,                    /* -mlong-calls */
  OPT_mlong32 = 1190,                        /* -mlong32 */
  OPT_mlong64 = 1191,                        /* -mlong64 */
  OPT_mlra = 1192,                           /* -mlra */
  OPT_mmad = 1193,                           /* -mmad */
  OPT_mmcount_ra_address = 1194,             /* -mmcount-ra-address */
  OPT_mmcu = 1195,                           /* -mmcu */
  OPT_mmemcpy = 1196,                        /* -mmemcpy */
  OPT_mmicromips = 1197,                     /* -mmicromips */
  OPT_mmt = 1198,                            /* -mmt */
  OPT_mnan_ = 1199,                          /* -mnan= */
  OPT_mno_float = 1200,                      /* -mno-float */
  OPT_mno_flush_func = 1201,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1202,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1203,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1204,                     /* -mno-mips3d */
  OPT_modd_spreg = 1205,                     /* -modd-spreg */
  OPT_mpaired_single = 1206,                 /* -mpaired-single */
  OPT_mplt = 1207,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1208,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1209,               /* -mrelax-pic-calls */
  OPT_mshared = 1210,                        /* -mshared */
  OPT_msingle_float = 1211,                  /* -msingle-float */
  OPT_msmartmips = 1212,                     /* -msmartmips */
  OPT_msoft_float = 1213,                    /* -msoft-float */
  OPT_msplit_addresses = 1214,               /* -msplit-addresses */
  OPT_msym32 = 1215,                         /* -msym32 */
  OPT_msynci = 1216,                         /* -msynci */
  OPT_mtune_ = 1217,                         /* -mtune= */
  OPT_muninit_const_in_rodata = 1218,        /* -muninit-const-in-rodata */
  OPT_mvirt = 1219,                          /* -mvirt */
  OPT_mvr4130_align = 1220,                  /* -mvr4130-align */
  OPT_mxgot = 1221,                          /* -mxgot */
  OPT_mxpa = 1222,                           /* -mxpa */
  OPT_n = 1223,                              /* -n */
  OPT_no_canonical_prefixes = 1224,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1225,              /* -no-integrated-cpp */
  OPT_noasmopt = 1226,                       /* -noasmopt */
  OPT_nocpp = 1227,                          /* -nocpp */
  OPT_nodefaultlibs = 1228,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1229,                   /* -nostartfiles */
  OPT_nostdinc = 1230,                       /* -nostdinc */
  OPT_nostdinc__ = 1231,                     /* -nostdinc++ */
  OPT_nostdlib = 1232,                       /* -nostdlib */
  OPT_o = 1233,                              /* -o */
  OPT_p = 1234,                              /* -p */
  OPT_pass_exit_codes = 1235,                /* -pass-exit-codes */
  /* OPT_pedantic = 1236, */                 /* -pedantic */
  OPT_pedantic_errors = 1237,                /* -pedantic-errors */
  OPT_pg = 1238,                             /* -pg */
  OPT_pie = 1239,                            /* -pie */
  OPT_pipe = 1240,                           /* -pipe */
  OPT_print_file_name_ = 1241,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1242,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1243,          /* -print-multi-directory */
  OPT_print_multi_lib = 1244,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1245,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1246,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1247,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1248,               /* -print-prog-name= */
  OPT_print_search_dirs = 1249,              /* -print-search-dirs */
  OPT_print_sysroot = 1250,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1251,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1252,                          /* -quiet */
  OPT_r = 1253,                              /* -r */
  OPT_remap = 1254,                          /* -remap */
  OPT_s = 1255,                              /* -s */
  OPT_s_bc_abi = 1256,                       /* -s-bc-abi */
  ...
  OPT_static_libgcj = 1266,                  /* -static-libgcj */
  OPT_static_libgfortran = 1267,             /* -static-libgfortran */
  OPT_static_libgo = 1268,                   /* -static-libgo */
  OPT_static_liblsan = 1269,                 /* -static-liblsan */
  OPT_static_libmpx = 1270,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1271,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1272,               /* -static-libstdc++ */
  OPT_static_libtsan = 1273,                 /* -static-libtsan */
  OPT_static_libubsan = 1274,                /* -static-libubsan */
  ...
  OPT_std_gnu__98 = 1301,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1302,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1303, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1304, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1305,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1306,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1307, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1308, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1309,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1310, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1311, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1312, */         /* -std=iso9899:2011 */
