...
int _main_djpeg(int argc ,char *argv[]);

int main(int argc, char **argv) {

	unsigned long long int t1,t2;
    char *args1[]={"djpeg","-debug","-outfile","Lenna128o.ppm","-fast", "-maxmemory","512","Lenna128.jpg"};
    //printf("DJPEG took million clock cycles\n");
    t1 = get_ticks();
    _main_djpeg(8,args1);
    t2 = get_ticks();
    printf("DJPEG took %'.6lf million clock cycles\n",(t2-t1)/1000000.0);
    return 0;
}
